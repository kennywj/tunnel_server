...
/*
 * duplicate define LIST_HEAD in tcpip\include\sys\queue.h
 */
#undef LIST_HEAD
/* MACROS */
...
static __inline__ void list_add(struct list_head *newent, struct list_head *afterthisent)
{
...
static __inline__ void list_add_tail(struct list_head *newent, struct list_head *beforethisent)
{
...
static __inline__ void list_del(struct list_head *ent)
{
...
/* Is this list empty? */
static __inline__ int list_empty(struct list_head *list)
{
